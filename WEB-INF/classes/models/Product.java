...
public class Product {
    ...
    public Product(String name, Integer price, String ageGroup, Integer quantity, User user) {
        this.name = name;
        this.price = price;
    ...
    public Product(Integer khilonaId, String name, Integer price, String ageGroup, Integer quantity) {
        this.productId = productId;
        this.name = name;
        this.price = price;
        this.ageGroup = ageGroup;
    ...
    public static ArrayList<Product> collectAllProducts() {
        ...
        try {
            ...
            while(rs.next()) {
                products.add(new Product(rs.getInt(1), rs.getString(2), rs.getInt(3), rs.getString(4), rs.getInt(5)));                
            }
    ...
    public boolean addProduct() {
        ...
        try{ 
           ...
           String query = "insert into products (name,price,age_group,quantity,user_id) value (?,?,?,?,?)";
